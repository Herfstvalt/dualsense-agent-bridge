...
| --- | --- | --- |
| 0. Baseline without hardware | pass | `swift test` (279 tests, 23 suites) and `swift build -c release` pass; the starter profile exports R3 as `hold control+s`, Square as `repeat delete`, and the confirmed Command-Z/C/V shortcuts. |
