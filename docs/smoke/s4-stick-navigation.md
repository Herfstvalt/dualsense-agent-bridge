...
| --- | --- | --- |
| 0. Baseline without hardware | pass | `swift test` (199 tests, 17 suites) and a clean release build pass with no warnings; `doctor`, `profile --starter`, and a version 1 profile without a `navigation` section were all verified. |
